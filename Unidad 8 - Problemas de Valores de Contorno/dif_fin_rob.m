function [x,y]=dif_fin_rob(f,inter,ycd,rob,L)
  ...
  % y(a)=alpha , Ay'(b) + By(b) = C             -->en ley de enfriamiento de newton: Au'=-k0*u'  Bu(b) = Hu(L)  C=q+HuE
...
y=[ycd;ys(1:end-1)];  %el último (end) corresponde al nodo ficticio por eso no se agrega
